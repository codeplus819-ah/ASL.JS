...
class ComponentManager {
  ...
  addComponent = (name, filePath, javascript, css) => {
    this.components[name] = new Component(name, filePath, javascript, css);
  };
  ...
  addComponentByObject = (componentObject) => {
    this.components[componentObject.name] = componentObject;
  };
}